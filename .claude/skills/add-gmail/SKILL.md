...
5. Rebuild: `cd container && ./build.sh && cd .. && npm run build && launchctl kickstart -k gui/$(id -u)/com.aquaclaw` (macOS) or `systemctl --user restart aquaclaw` (Linux)
...
8. Rebuild: `cd container && ./build.sh && cd .. && npm run build && launchctl kickstart -k gui/$(id -u)/com.aquaclaw` (macOS) or `systemctl --user restart aquaclaw` (Linux)
