...
<html><head><title>AquaClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'aquaclaw_qr_start';
...
<html><head><title>AquaClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('aquaclaw_qr_start');</script>
</body></html>`;
