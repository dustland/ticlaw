...
8. Rebuild: `npm run build && ./container/build.sh && launchctl unload ~/Library/LaunchAgents/com.aquaclaw.plist && launchctl load ~/Library/LaunchAgents/com.aquaclaw.plist` (macOS) or `npm run build && ./container/build.sh && systemctl --user restart aquaclaw` (Linux)
