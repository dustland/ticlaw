export const AQUACLAW_DIR = '.aquaclaw';
export const STATE_FILE = 'state.yaml';
export const BASE_DIR = '.aquaclaw/base';
export const BACKUP_DIR = '.aquaclaw/backup';
export const LOCK_FILE = '.aquaclaw/lock';
export const CUSTOM_DIR = '.aquaclaw/custom';
